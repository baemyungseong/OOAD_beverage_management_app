...
class atMainTaskDetailScreen extends StatefulWidget {
  ...
  atMainTaskDetailScreen(this.id, this.code, this.timestamp, this.totalMoney, {Key? key}) : super(key: key);

  @override
  _atMainTaskDetailScreenState createState() => _atMainTaskDetailScreenState();
}

class _atMainTaskDetailScreenState extends State<atMainTaskDetailScreen> {
