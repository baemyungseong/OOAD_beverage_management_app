...
class svDashboardManagementScreen extends StatefulWidget {
  ...
  @override
  State<svDashboardManagementScreen> createState() =>
      _svDashboardManagementScreenState();
}

class _svDashboardManagementScreenState
    extends State<svDashboardManagementScreen>
...
controlSelectDrink(String _drinkID, String _drinkImageURL, String _drinkName, String _drinkDescription, String _drinkUnitPrice) async {
  ...
  if (doc.exists) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            svDrinkChosingScreen(_drinkID, _drinkImageURL, _drinkName, _drinkDescription, _drinkUnitPrice),
      ),
    );
  }
  else {
