...
class btDrinkEditingScreen extends StatefulWidget {
  String idDrink;
  btDrinkEditingScreen({Key? key, required this.idDrink}) : super(key: key);

  @override
  _btDrinkEditingScreenState createState() =>
      _btDrinkEditingScreenState(idDrink);
}
...
class _btDrinkEditingScreenState extends State<btDrinkEditingScreen> {
  ...
  Drink drink = Drink(
      ...
      image: '',
      price: '');
  Future getDrinkDetail() async {
    FirebaseFirestore.instance
        .collection('drinks')
        .where('id', isEqualTo: idDrink)
        .snapshots()
        .listen((value) {
      setState(() {
        drink = Drink.fromDocument(value.docs.first.data());
  ...
  _btDrinkEditingScreenState(this.idDrink);
              ...
              Container(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      //             decoration: BoxDecoration(
                      //               color:
                      //                   (volume == "500ml") ? blueLight : white,
                      //               border: (volume == "500ml")
                      //                   ? Border()
                      //                   : Border(
                      //                       top: BorderSide(
                      //                           width: 1, color: blueLight),
                      //                       left: BorderSide(
                      //                           width: 1, color: blueLight),
                      //                       right: BorderSide(
                      //                           width: 1, color: blueLight),
                          ...
                          GestureDetector(
                            ...
                            onTap: () {
                              ...
                              showSnackBar(context,
                                  'The drink have been edited!', 'success');
                            },
                            child: AnimatedContainer(
                              alignment: Alignment.center,
                              duration: Duration(milliseconds: 300),
